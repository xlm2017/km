...
// 获得当前元素所在的页码
function getPageIndexByDom (dom, pageHeight) {
...
function injectCss (documentBook) {
  let css = documentBook.createElement("style");
  css.type = "text/css";
  let str = `
  body {
...
function injectJs (documentBook, scriptStr) {
  let script = documentBook.createElement("script");
