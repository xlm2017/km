...
window.onload = () => {
  setTimeout(() => {
    ...
    let pageHeight = getPageViewHeight() - 16;
    ...
    for (let i = 1; i < arr.length; i++) {
      let element = arr[i]; if (i == 2) { // debugger; } if (i>= 1) {
        // 当前一个元素拆分的页
        let newArr = [];
        // 整个dom归属的页码
        let endIndex = i;
    ...
    setTimeout(() => {
      ...
      // 使用turn.js // console.log("jquery", $, $("#page")); let width=document.body.clientWidth; let
      height = getPageViewHeight();
